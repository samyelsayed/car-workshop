...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'كلمة المرور المُدخلة ضعيفة جداً وسهلة التخمين، يرجى اختيار كلمة مرور أكثر أماناً.',
    ],
    ...
    */
    ...
    'custom' => [
        'email' => [
            ...
            'exists' => 'لا يوجد حساب بهذا البريد الإلكتروني',
        ],
        'password' => [
        ...
        'phone' => [
            ...
            'regex' => 'الرجاء إدخال رقم هاتف مصري صحيح',
