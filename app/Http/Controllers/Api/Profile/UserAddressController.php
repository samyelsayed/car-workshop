...
class UserAddressController extends Controller
{
    ...
    public function __construct( UserAddressService $addressService)
      ...
      return $this->Data(['addresses' => UserAddressResource::collection($addresses)], 'Data retrieved successfully');
    ...
    public function store(StoreAddressRequest $request){
     $add_address =$this->addressService->createAddress($request->user(), $request->validated());
       ...
       return $this->Data(['address' => new UserAddressResource($add_address)], 'Address added successfully');
...
public function update(UpdateAddressRequest $request, int $id){
 ...
 return $this->Data(['address' => new UserAddressResource($address)], 'Address updated successfully');
